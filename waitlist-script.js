...
// Load colleges from embedded data
function loadColleges() {
  // Major universities across the US
  colleges = [
    ...
    "Arizona State University - The Gila Valley",
    "Arizona State University - Yuma",
    ...
    "Arizona State University - Northeastern Arizona",
    ...
    "TONI&GUY Hairdressing Academy - Costa Mesa",
    ...
    "Otero College",
    "Otero College - La Junta High School",
    "Otero College - Fort Lyon Colorado Coalition for the Homeless",
    ...
    "Three Rivers Community College - Corrigan-Radgowski Correctional Center",
    ...
    "Keiser University - Residential (Flagship)",
    ...
    "Bard College - New York Public Library, Countee Cullen Branch",
    "Bard College - Bard Globalization and International Affairs Program",
    ...
    "Bucks County Community College-Gene and Marlene Epstein Campus at Lower Bucks",
    ...
    "UPMC Jameson School of Nursing - UPMC Hamot",
    ...
    "UPMC Shadyside - at UPMC Harrisburg",
    ...
    "Shoreline Community College - CNC Machinists Program , Georgetown SSC",
    ...
    "NUC University",
    "NUC University - Arecibo",
    "NUC University - RPo Grande",
    "NUC University - Ponce",
    "NUC University - Caguas",
    "NUC University - Mayagsez",
    ...
    "Colegio de CinematografAa Artes y Television",
    ...
    "Rasmussen UniversityIRomeoville/Joliet",
    "Rasmussen University-Mokena/Tinley Park",
    ...
    "Elevate Salon Institute - Elevate Salon Institute",
    ...
    "Milan Institute of Cosmetology-Vacaville",
    ...
    "Chrysm Institute of Esthetics (The) - Hampton",
    ...
    "Lynnes Welding Training - Ramsey",
    ...
    "Ricci's Toni & Guy Hairdressing Academy/TIGI Creative School",
    ...
    "Miller-Motte College-Edge Tech Academy",
    ...
    "Valley College - Fairlawn - School of Nursing",
    ...
    "Kansas College of Osteopathic Medicine Kansas",
    "LLB Phlebotomy Training Center LLC",
    ...
    "Jersey College - Brooksville",
    "Jersey College - Naples",
    "Atlantis University-Florida Palms University",
    "Lynnes Welding Training - Ramsey",
    "Beyond the Bell CPR Training",
    "Evangel University-College of Online Learning",
    "Marian University-Ancilla",
    "Arizona State University - Northeastern Arizona",
    "Arizona State University - Mesa City Center",
    "Graceland University - North Central Missouri College",
    "Huston - Tillotson University - Center for Entrepreneurship and Innova",
    "Spa Tech Institute-North Andover",
    "Aveda Arts & Sciences Institute Lafayette-Arlington",
    "Shawnee Beauty College-Academy of Cosmetology & Barbering",
    ...
    "NEXUS University",
    "Larkin University",
    "Pathways College-Arizona",
    "Fort Collins Bible College",
    "Minnesota North College - Mesabi Range Eveleth",
    "Compu-Sher Learning Solutions",
    "Pontifex University",
    "Xtylo Beauty College",
    ...
    "Elevate Salon Institute - Elevate Salon Institute",
    "Bard College - Albion Correctional Facility",
    "Arizona College-Falls Church",
    "Arizona College-Ontario",
    "National Tractor Trailer School",
    "Galen Health Institutes-Houston",
    "Galen Health Institutes-Pikeville",
    "Ivy Tech Community College of Indiana - Region 6 - Marion",
    "Ivy Tech Community College of Indiana - Region 1 - Valparaiso",
    "Ivy Tech Community College of Indiana - Region 11 - Riverfront Campus",
    "Ivy Tech Community College of Indiana - Region 8 - Noblesville",
...
function setupCollegeSearch() {
  const collegeInput = document.getElementById("collegePage");
  ...
  collegeInput.addEventListener("input", function () {
    ...
    if (matches.length > 0) {
      dropdown.innerHTML = matches
        .map(
          (college) =>
            `<div class="college-option" data-college="${college}">${college}</div>`
        )
        .join("");
      dropdown.classList.add("show");

      // Add click handlers
      dropdown.querySelectorAll(".college-option").forEach((option) => {
        option.addEventListener("click", function () {
          collegeInput.value = this.dataset.college;
          dropdown.classList.remove("show");
        });
      });
    } else {
  ...
  collegeInput.addEventListener("keydown", function (e) {
    const highlighted = dropdown.querySelector(".college-option.highlighted");
    ...
    if (e.key === "ArrowDown") {
      ...
      if (!highlighted) {
        ...
        const next = highlighted.nextElementSibling || options[0];
      ...
      if (!highlighted) {
        ...
        highlighted.classList.remove("highlighted");
        const prev =
          highlighted.previousElementSibling || options[options.length - 1];
        prev.classList.add("highlighted");
      }
    } else if (e.key === "Enter" && highlighted) {
      e.preventDefault();
      collegeInput.value = highlighted.dataset.college;
      dropdown.classList.remove("show");
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const form = document.getElementById("waitlistPageForm");
  ...
  form.addEventListener("submit", async function (e) {
    ...
    if (!email.endsWith(".edu")) {
      alert("Please use a university email address ending in .edu");
      return;
    }
    ...
    try {
      ...
      if (response.ok) {
        ...
        // Update success message with position number
        const position = result.user?.waitlist_position || "Unknown";
        successDiv.innerHTML = `
          <h3 style="color: #0d1a45;">🎉 Thanks for joining the Versa waitlist!</h3>
          <p>You are number <strong>${position}</strong> on the waitlist.</p>
          <p>We'll notify you as soon as Versa is ready to launch!</p>
          <button class="back-home-btn" onclick="goBackToMain()">Navigate back to home</button>
        `;
...
document.addEventListener("DOMContentLoaded", function () {
  const emailInput = document.getElementById("emailPage");
